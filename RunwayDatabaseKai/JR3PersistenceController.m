...
-(void) initializeCoreData{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"RunwayDatabaseKai" withExtension:@"momd"];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^{
        ...
        NSURL *storeURL = [documentsURL URLByAppendingPathComponent:@"RunwayDatabaseKai.sqlite"];
